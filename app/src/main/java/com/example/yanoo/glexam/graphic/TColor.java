...
public class TColor {
    ...
    public static final TColor CYAN   = new TColor(11/256.0f,205/256.0f,4/256.0f,1.0f);
    ...
    public static final TColor YELLO  = new TColor(255/256.0f,235/256.0f,59/256.0f,1.0f);
