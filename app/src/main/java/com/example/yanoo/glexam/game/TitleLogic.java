...
public class TitleLogic implements GameLogic {
    ...
    public void          registUI(final GLRenderer renderer) {
        renderer.registTUI(new TButton(0.1f, 0.1f, 0.9f, 0.2f, Util.getRString(R.string.Start),  new TButton.Listener() {
            @Override
        ...
        renderer.registTUI(new TButton(0.1f, 0.2f, 0.9f, 0.3f, Util.getRString(R.string.Load),  new TButton.Listener() {
            @Override
            public void press(TouchListener.TouchEvent tl) {
                Intent it = null;
        ...
        renderer.registTUI(new TButton(0.1f, 0.3f, 0.9f, 0.4f, Util.getRString(R.string.Setting),  new TButton.Listener() {
            @Override
            public void press(TouchListener.TouchEvent tl) {
        ...
        renderer.registTUI(new TButton(0.1f, 0.4f, 0.9f, 0.5f, Util.getRString(R.string.MapEditor),  new TButton.Listener() {
            @Override
            public void press(TouchListener.TouchEvent tl) {
        ...
        renderer.registTUI(new TButton(0.1f, 0.8f, 0.9f, 0.9f, Util.getRString(R.string.Exit),  new TButton.Listener() {
            @Override
            public void press(TouchListener.TouchEvent tl) {
